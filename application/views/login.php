...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="../../index2.html" class="h1"><b>Sistema</b>Git</a>
    </div>
    <div class="card-body">
      <p class="login-box-msg">Entre para começar a usar</p>
        ...
        <div class="input-group mb-3">
          <input name="login" class="form-control" placeholder="Email ou Usuario">
